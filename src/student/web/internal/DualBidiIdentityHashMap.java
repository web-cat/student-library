...
public class DualBidiIdentityHashMap<Key,Value> extends AbstractDualBidiMap{
     ...
     */
    protected DualBidiIdentityHashMap(Map<Key,Value> normalMap, Map<Key,Value> reverseMap, BidiMap inverseBidiMap) {
    ...
    protected BidiMap createBidiMap(Map normalMap, Map reverseMap, BidiMap inverseBidiMap) {
        return new DualBidiIdentityHashMap<Key,Value>(normalMap, reverseMap, inverseBidiMap);
    }
