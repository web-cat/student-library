...
//-------------------------------------------------------------------------
/**
 *  Used by the {@link FlexibleMapper} and {@link FlexibleFieldSetConverter}
 *  to represent unknown classes in an object being reconstructed--typically
 *  because classes that were present when the object was originally
 *  stored are not accessible in the current class loader during
 *  reconstruction.
 *  <p>
