...
public class ComponentTester extends Robot {
    ...
    */
    ...
    /** Clears the internal cache of all testers stored using
     * <code>setTester()</code> or <code>getTester()</code>.  This method
     * is primarily for use in test case classes, since testers should not
     * be reused across tests.
     */
    public static void clearTesterCache() {
        testers.clear();
    }
